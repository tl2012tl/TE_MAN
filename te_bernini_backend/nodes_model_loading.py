...
class WanVideoModelLoader:
    ...
    def loadmodel(self, model, base_precision, load_device,  quantization,
        ...
        if proj1_key is not None and ("blocks.0.audio_cross_attn.q_norm.weight" in sd or "blocks.0.audio_cross_attn.q_norm.weight_int8" in sd):
            ...
            raise RuntimeError("MultiTalk/LongCat support has been removed from the slim TE Bernini backend.")
        ...
        # SkyreelsV3
            ...
            raise RuntimeError("SkyReels audio support has been removed from the slim TE Bernini backend.")
            ...
            # init audio module
            raise RuntimeError("MultiTalk support has been removed from the slim TE Bernini backend.")
...
class WanVideoTinyVAELoader:
    ...
    def loadmodel(self, model_name, precision, parallel=False):
        raise RuntimeError("TAEHV VAE preview model support has been removed from the slim TE Bernini backend.")
