...
class WanVideoSampler:
    ...
    def process(self, model, image_embeds, shift, steps, cfg, seed, scheduler, riflex_freq_index, text_embeds=None,
        ...
        if humo_audio is not None:
            raise RuntimeError("HuMo support has been removed from the slim TE Bernini backend.")
        ...
        if mtv_input is not None:
            raise RuntimeError("MTV Crafter support has been removed from the slim TE Bernini backend.")
